...
function pick(route){state.route=route;meter.classList.remove("hidden");const c=characters[route];scene({who:c.name,body:route==="hoshi"?"おや。空からお客さま？　……ふふ、歓迎するよ。ボクはスターマイン。ホシくんと呼んでくれるだろう？":route==="citrus"?"お怪我はありませんか？　ここは雲上庭園です。私はシトラス。まずは安全規則をご説明しますね。":"まあ。痛いところはありませんか？　ここは夢の保健室。ネムリと申します。どうぞ、こちらへ。",bg:c.visual,gain:12,opts:[{label:"助けてくれてありがとう",go:()=>daily()},{label:"ここがどこか教えてほしい",go:()=>daily()},{label:"帰る方法を探したい",go:()=>daily()}]});}
